...
<html lang="en">
  ...
  <img src="https://sman2mojokerto.sch.id/templates/core/img/logo.png" alt="" width="30" height="30" class="d-inline-block align-top">
  ...
  <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
    <div class="navbar-nav ml-auto">
      ...
      <a class="nav-item nav-link active" href="/About">Contact</a>
    </div>
  </div>
  </div>
</nav>
...
<div class="jumbotron jumbotron-fluid">
  <div class="container">
    <h1 class="display-4"><img src="https://sman2mojokerto.sch.id/templates/core/img/logo.png" alt="" width="150" height="150"><br>SMA NEGERI 2 KOTA MOJOKERTO <br><br><span>Menjadi Sekolah Unggul dalam Imtaq, Iptek, Budi Pekerti, Peduli Lingkungan dan Berwawasan Internasional</span></h1>
  </div>
</div>
<!-- Akhir Jumbotron -->
<!-- Container -->
<div class="container">
  ...
  <div class="container">
    ...
    <div class="row justify-content-center">
      <div class="col-lg-4">
      <div class="card">
  <img src="{{url('img/sma.png')}}" class="card-img-top" alt="...">
  <div class="card-body">
    <h5 class="card-title">Tentang Kami</h5>
    <p class="card-text">SMA Negeri 2 Kota Mojokerto (SMANDA) adalah Sekolah Menengah Atas Negeri bertaraf internasional yang biasa disebut Buwitashakti (Bumi Wiyata Setya Bhakti) dan Inscada (Innovative School of SMANDA) yang berada di Kota Mojokerto, Jawa Timur.</p>
  </div>
  <ul class="list-group list-group-flush">
    <li class="list-group-item"><img src="https://sman2mojokerto.sch.id/templates/core/img/logo.png" alt="" width="30" height="30"> &nbsp; SMA NEGERI 2 KOTA MOJOKERTO</li>
    <li class="list-group-item"><img src="https://img.icons8.com/doodle/96/000000/google-maps-new.png" width="30" height="30"/> &nbsp; JL. RAYA IJEN NO. 9, WATES, MAGERSARI, KOTA MOJOKERTO 61317</li>
    <li class="list-group-item"><img src="https://img.icons8.com/dusk/64/000000/fax.png" width="30" height="30"/> &nbsp; (0321) 331116</li>
  </ul>
</div>
</div>
      <div class="col-lg-6">
